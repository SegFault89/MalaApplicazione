...
fun AnimatoreRangeListItem(
    ...
    val disponibilita = animatore.getTipoDisponibilitaInRange(giorni)
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(MarginNormal)) {
            Text(
                text = "${animatore.label}${if (disponibilita != DisponibilitaEnum.DISPONIBILE) "*" else ""}",
